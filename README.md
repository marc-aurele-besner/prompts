...
Are you looking for a curated list of conversation prompts for OpenAI ChatGPT/GPT-style models? This repository contains a comprehensive set of prompts designed to showcase model capabilities and help you experiment, learn, and build.

## Features

- Wide range of conversation topics—from general knowledge and trivia to specialized domains
- Regular updates with new and improved prompts to keep the list fresh and relevant
- Clear categorization and organization of prompts for easy discovery
- Contribution guidelines and an open contribution process so the community can help grow the list

Keywords: OpenAI, ChatGPT, GPT-4, chatbots, NLP, conversation prompts, chat model, AI, conversational AI.

## Usage

For best results, start a new conversation and paste one of these prompts as the first message.
...
- [Language](#language)
- [Teacher](#teacher)
- [Engineering & Dev Tools](#engineering--dev-tools)
- [Crypto Fun (Entertainment purposes only) 😂](#crypto-fun-entertainment-purposes-only-)

## Descriptions & Social Media

### The "GitHub repository description expert"

This prompt was used to write the description above.
...
Welcome to this comprehensive guide on generating images with ChatGPT. Below are 50 different use cases with corresponding prompts to help you create icons, logos, backgrounds, prints, and more. Each prompt is designed to elicit detailed and high-quality images, complete with format specifications and a request for a gen_id.
...
```txt
I want you to act as a pull request reviewer. Given a diff or a link to a PR, you will:
- Summarize the change in 2–3 bullet points
- Identify correctness, performance, security, and accessibility issues
- Call out unclear naming, missing tests, and edge cases
- Suggest concrete edits with code snippets where helpful
- Mark blockers vs. non-blockers

Here is the PR context: <paste diff or description here>
```
